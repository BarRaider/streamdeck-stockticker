...
namespace StockTicker.Backend.Stocks
{
    ...
    public class YahooV6StockProvider : IStockInfoProvider
    {
        ...
        private const string STOCK_URI = @"https://query1.finance.yahoo.com/v6/finance/quote?lang=en-US&region=US&corsDomain=finance.yahoo.com&fields=symbol,marketState,regularMarketPrice,regularMarketChange,regularMarketChangePercent,regularMarketDayHigh,regularMarketDayLow&symbols={0}";

        private static YahooV6StockProvider instance = null;
        ...
        public static YahooV6StockProvider Instance
        {
            get
            {
                if (instance != null)
                ...
                lock (objLock)
                {
                    if (instance == null)
                    {
                        instance = new YahooV6StockProvider();
                    }
                    return instance;
                }
            }
